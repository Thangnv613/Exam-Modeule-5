            ...
            <table className=" w-full table-auto">
              <thead>
                <tr className="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                  ...
                  <th className="py-3 px-6 text-center">Giá(đ)</th>
              ...
              <tbody className="text-gray-600 text-sm font-light">
                {products.map((item, key) => (
                  <tr className="border-b border-gray-200 bg-gray-50 hover:bg-gray-100">
                    <td className="py-6 px-20 text-left text-lg">{key + 1}</td>
                    <td className="py-6 px-20 text-left text-lg">
                      {item.name}
                    </td>
                    <td className="py-6 px-20 text-center text-lg">
                      {item.price}
                    </td>
                    <td className="py-6 px-20 text-center text-lg">
                      {item.stock}
                    ...
                    <td className="py-6 px-20 text-center text-lg">
                      <div className="flex item-center justify-center">
                        ...
                        <div className="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                          <svg
                          onClick={()=>{navigate(`/sua-doi/${item.id}`)}}
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                            viewBox="0 0 24 24"
                            stroke="currentColor"
